        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('INICIO.*')">
                        <b><font color="magenta">{{ __('INICIO') }}</font></b>
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="url('dashboard/Category')" :active="request()->routeIs('Category.*')">
                        <b><font color="blue">{{ __('CATEGORIA') }}</font></b>
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="url('dashboard/Article')" :active="request()->routeIs('Article.*')">
                        <b><font color="blue">{{ __('ARTICULO') }}</font></b>
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="url('dashboard/Income')" :active="request()->routeIs('Income.*')">
                        <b><font color="green">{{ __('INGRESO') }}</font></b>
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="url('dashboard/income_details')" :active="request()->routeIs('income_details.*')">
                        <b><font color="green">{{ __('DETALLE DE INGRESO') }}</font></b>
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="url('dashboard/sales')" :active="request()->routeIs('sales.*')">
                        <b><font color="brown">{{ __('VENTA') }}</font></b>
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="url('dashboard/sales_details')" :active="request()->routeIs('sales_details.*')">
                        <b><font color="brown">{{ __('DETALLE DE VENTA') }}</font></b>
                    </x-nav-link>
                </div>
            </div>   
